...
function BookDetail() {
    const { id } = useParams();
    const book = popularBooks.find((book) => book.id == id);
        ...
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center">
                <div className="text-center p-8 bg-white rounded-lg shadow-md">
                    ...
                    <Link to="/" className="bg-slate-800 text-white px-6 py-2 rounded-lg inline-flex items-center">
    ...
    return (
        <div className="min-h-screen bg-slate-50 py-8">
            <div className="container mx-auto px-4">
                {/* Back Button */}
                <div className="mb-6">
                    <Link to="/" className="inline-flex items-center text-slate-800 hover:text-amber-600 transition-colors">
                        <ArrowBackIcon className="mr-1" /> Back to Home
                    </Link>
                </div>
